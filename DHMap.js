...
function searchAddress(street){
  ...
  let s = "" + blockNum + " "  + st;
  console.log("END OF SEARCHADDRESS " + s);
    ...
    if(searches > Intersections.length/4){                          //If searches exceed 1/4 of the Intersections, give up and try a different path
      ...
      if(!first){
        ...
        if(neighborsI.length == 1){
         alert("Could not find route first try, Press OK to check another path");
